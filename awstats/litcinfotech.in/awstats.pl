...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/litcindore/domains/litcindore.com/awstats/litcinfotech.in/.data"
	# Other possible directories :				"/usr/local/etc/awstats",
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/litcindore/domains/litcindore.com/awstats/litcinfotech.in/.data",
